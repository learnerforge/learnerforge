...
| Area | Technologies |
|---|---|
| **Backend** | FastAPI · Flask · Django · SQLAlchemy · Alembic · PostgreSQL · SQLite |
| **AI / ML** | Gemini · OpenAI · scikit-learn · spaCy · TextRank · Q-learning · NLP |
| **Frontend** | React 19 · Vite · Tailwind CSS · Zustand · React Flow · AOS |
...
- [**smart-mobility-insights**](https://github.com/learnerforge/smart-mobility-insights) — Django mobility platform wired to **11 government datasets** (~210K records)
- [**SkillGapAI_Project**](https://github.com/learnerforge/SkillGapAI_Project) — employability analyzer with **Random Forest + Decision Tree** models
- [**resume-screening-ml**](https://github.com/learnerforge/resume-screening-ml) — ATS-style resume matcher using **TF-IDF + spaCy**
- [**login-page**](https://github.com/learnerforge/login-page) — "Scholar's Hall" login page, pure-CSS art, no images
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=learnerforge&layout=compact&theme=tokyonight&hide_border=true&bg_color=0A2540" width="70%" alt="Top languages"/>
</p>
...
<p align="center">
  <i>"Build, learn, grow — the Forge way."</i>
</p>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:3FA1FF,100:0A2540&height=80&section=footer" width="100%"/>
